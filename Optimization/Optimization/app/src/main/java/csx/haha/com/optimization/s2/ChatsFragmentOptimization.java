...
public class ChatsFragmentOptimization extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ChatAdapterOptimization adapter = new ChatAdapterOptimization(getActivity(), chats);

        View rootView = inflater.inflate(R.layout.fragment_chats_s2_optimization, container, false);
