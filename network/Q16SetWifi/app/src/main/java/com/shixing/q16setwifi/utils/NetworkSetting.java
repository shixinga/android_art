...
import com.shixing.q16setwifi.MainActivity;
...
public class NetworkSetting {
    ...
    public static int putMyData(String name, String password) {
        RequestBody requestBody = RequestBody.create(XML,getXml(name, password));
    ...
    private static String getXml(String name, String password) {

        String nameHex = StringToHex.stringToHexString(name);
        String passwordHex = StringToHex.stringToHexString(password);
        return "<?xml version:\"1.0\" encoding=\"UTF-8\" ?>" +
                "<io:Profile  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:dd=\"http://www.hp.com/schemas/imaging/con/dictionaries/1.0/\"" +
                ...
                "<io:AdapterProfile><io:WifiProfile>" +
                "<wifi:SSID>" + nameHex + "</wifi:SSID>" +
                ...
                "<wifi:PassPhrase>" + passwordHex + "</wifi:PassPhrase>" +
                "</io:WpaPassPhraseInfo></io:KeyInfo></io:WifiProfile></io:AdapterProfile></io:Profile>";
    }
