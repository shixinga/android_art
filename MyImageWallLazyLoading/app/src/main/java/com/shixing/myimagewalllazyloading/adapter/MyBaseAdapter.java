package com.shixing.myimagewalllazyloading.adapter;
...
import com.shixing.myimagewalllazyloading.imageloader.MyImageLoader;
...
public class MyBaseAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = mLayoutInflater.inflate(R.layout.layout_item_gridview, null);
