...
//    }
    ...
    private class Adapter extends RecyclerAdapter<Message> {
        ...
        @Override
        protected MyViewHolder<Message> myOnCreateViewHolder(View root, int viewType) {
            switch (viewType) {
                // 左右都是同一个
    ...
    class BaseHolder extends RecyclerAdapter.MyViewHolder<Message> {
