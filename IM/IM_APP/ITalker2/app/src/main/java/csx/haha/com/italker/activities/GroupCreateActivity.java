...
import csx.haha.com.common.app.PresenterToolbarActivity;
import csx.haha.com.common.widget.PortraitView;
import csx.haha.com.common.widget.recycler.RecyclerAdapter;
import csx.haha.com.factory.presenter.group.GroupCreateContract;
import csx.haha.com.factory.presenter.group.GroupCreatePresenter;
...
public class GroupCreateActivity extends PresenterToolbarActivity<GroupCreateContract.Presenter>
    ...
    public void onCreateSucceed() {
        // 提示成功
        hideLoading();
        MyApplication.showToast(R.string.label_group_create_succeed);
        finish();
    }
    ...
    private class Adapter extends RecyclerAdapter<GroupCreateContract.ViewModel> {
        ...
        @Override
        protected MyViewHolder<GroupCreateContract.ViewModel> myOnCreateViewHolder(View root, int viewType) {
    ...
    class ViewHolder extends RecyclerAdapter.MyViewHolder<GroupCreateContract.ViewModel> {
        @BindView(R.id.im_portrait)
        PortraitView mPortrait;
