...
import csx.haha.com.factory.presenter.contact.ContactContract;
import csx.haha.com.factory.presenter.contact.ContactPresenter;
...
public class ContactFragment extends PresenterFragment<ContactContract.Presenter>
    ...
    protected void initWidget(View root) {
        ...
        mAdapter.setListener(new RecyclerAdapter.AdapterListenerImpl<User>() {
            @Override
            public void onItemClick(RecyclerAdapter.MyViewHolder holder, User user) {
                // 跳转到聊天界面
    ...
    class ViewHolder extends RecyclerAdapter.MyViewHolder<User> {
