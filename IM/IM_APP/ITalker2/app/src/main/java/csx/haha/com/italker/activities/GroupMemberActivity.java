...
import csx.haha.com.factory.presenter.group.GroupMembersContract;
import csx.haha.com.factory.presenter.group.GroupMembersPresenter;
import csx.haha.com.italker.R;
import csx.haha.com.italker.frags.GroupMemberAddFragment;
...
public class GroupMemberActivity extends PresenterToolbarActivity<GroupMembersContract.Presenter>
    ...
    protected void initWidget() {
        ...
        mRecycler.setAdapter(mAdapter = new RecyclerAdapter<MemberUserModel>() {
            ...
            @Override
            protected MyViewHolder<MemberUserModel> myOnCreateViewHolder(View root, int viewType) {
    ...
    class ViewHolder extends RecyclerAdapter.MyViewHolder<MemberUserModel> {
