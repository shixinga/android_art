 ...
 * @version 1.0.0
 */
public abstract class PresenterToolbarActivity<Presenter extends BaseContract.IPresenter>
        extends ToolbarActivity implements BaseContract.IView<Presenter> {
